export default {
  ...
  group: {
    ...
    credentials: {
      ...
      turnState: {
        title: 'Codex ターン状態の注入',
        hint: 'この認証情報からの各アップストリームリクエストで X-Codex-Turn-State をこの値に上書きします。空欄で注入しません。',
        placeholder: 'X-Codex-Turn-State を貼り付け',
        active: '注入中',
        inactive: '未注入',
        length: '{count} 文字',
        ...
        models: '対象モデル',
        modelsHint:
          'これらのモデルにのみ注入します。カンマ区切りで、末尾の * は前方一致です。空欄ですべてのモデルが対象になります。モデルを特定できないリクエストにはそのまま注入します。',
      ...
      customGateway: {
        title: 'カスタムゲートウェイ (Base URL)',
        hint: 'この認証情報に個別のゲートウェイエンドポイントを設定し、グループのデフォルト設定を上書きします。空欄でグループに従います。',
        placeholder: 'https://...',
        active: 'カスタム設定済み',
        default: 'グループに従う',
        invalid: '有効な HTTPS URL を入力してください（パラメータやアンカーは不可）',
        apply: '保存',
        clear: 'デフォルトに戻す',
      },
