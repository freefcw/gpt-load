export default {
  ...
  group: {
    ...
    credentials: {
      ...
      turnState: {
        title: 'Codex 轮次状态注入',
        hint: '该凭据的每次上游请求都会用这里的值覆盖 X-Codex-Turn-State；留空表示不注入。',
        placeholder: '粘贴 X-Codex-Turn-State',
        active: '已注入',
        inactive: '未注入',
        length: '{count} 字符',
        ...
        modelsAll: '全部模型',
        modelsScoped: '按模型限定',
        modelsInvalid: '模型名只能用字母、数字与 - _ . : /，可用 * 结尾',
        apply: '保存',
        clear: '清除',
      },
      customGateway: {
        title: '自定义网关 (Base URL)',
        hint: '为此凭据指定单独的网关地址，覆盖分组默认配置；留空表示使用分组默认网关。',
        placeholder: 'https://...',
        active: '已自定义',
        default: '跟随分组',
        invalid: '必须是合法的 HTTPS 地址（不能含参数或锚点）',
        apply: '保存',
        clear: '恢复默认',
      },
